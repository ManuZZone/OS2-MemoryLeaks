...
class ProfileFragment : Fragment(), OnRefreshListener, ConfirmDialogFragmentCallback, MultiOptionDialogSingleCallback<String> {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
         ...
         */
        /**
         * Prima del leak l'attributo binding non era nullable ed era utilizzato direttamente senza il getter e, inoltre,
         * non veniva deferenziato nel metodo onDestroyView
         *
         */
